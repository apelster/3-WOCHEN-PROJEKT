...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      "service_k4r4wrs",  // Ersetzen Sie dies durch Ihre EmailJS-Service-ID
      "template_kyeyihw", // Ersetzen Sie dies durch Ihre EmailJS-Template-ID
      templateParams,
      "tKK2H8TUXqqd8k17m"      // Ersetzen Sie dies durch Ihre EmailJS-User-ID
    )
    .then((response) => {
